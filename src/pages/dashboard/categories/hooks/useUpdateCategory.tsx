...
export function useUpdateCategory(slug: string) {
  ...
  const isModified = data.titulo !== originalData.titulo || data.descripcion !== originalData.descripcion;
  ...
  const updateCategoria = async (e: React.FormEvent) => {
    ...
    if (data.titulo === originalData.titulo && data.descripcion === originalData.descripcion) {
      return;
    }
