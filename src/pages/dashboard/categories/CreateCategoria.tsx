...
export function CreateCategory() {
  const { data, errorTitulo, errorDescripcion, handleChange, createCategoria, isEmpty } = useCreateCategory();
    ...
    <div>
      <Modal onClose={() => navigate('/dashboard/categorias')} modalId="create-category" modalTitle="Nueva Categoría">
        ...
        <div className="mt-6 flex justify-end">
          <button type="submit" disabled={isEmpty} onClick={createCategoria} className="primary-button">
            Guardar
          </button>
